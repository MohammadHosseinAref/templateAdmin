...
export const MENU_BRANCHES = ['مرکزی', 'شمال', 'جنوب', 'غرب'];

const SAMPLE_ITEMS: MenuItem[] = [
  { id: 's1',  name: 'Salade César',        categoryId: 'cat-0', subCategory: '', subSubCategory: '', price: 9.5,  description: 'Salade romaine, parmesan, croûtons, sauce César maison.',               photo: '', tags: ['Végétarien', 'Populaire'], recipe: [{ stockId: '1', quantity: 0.02 }, { stockId: '10', quantity: 0.04 }], available: true, prepTime: 10, visible: true, branches: ['مرکزی', 'شمال'] },
  ...
  { id: 's3',  name: 'Bruschetta tomates',  categoryId: 'cat-0', subCategory: '', subSubCategory: '', price: 6.5,  description: "Pain grillé frotté à l'ail, tomates fraîches, basilic et huile d'olive.", photo: '', tags: ['Vegan', 'Végétarien'],   recipe: [{ stockId: '1', quantity: 0.03 }, { stockId: '8', quantity: 0.15 }], available: true, prepTime: 8,  visible: true, branches: ['مرکزی'] },
  { id: 's4',  name: 'Poulet rôti',         categoryId: 'cat-1', subCategory: '', subSubCategory: '', price: 16.0, description: 'Demi-poulet rôti aux herbes de Provence, servi avec pommes de terre.',  photo: '', tags: ['Populaire', 'Halal'],     recipe: [{ stockId: '9', quantity: 0.35 }, { stockId: '1', quantity: 0.04 }], available: true, prepTime: 35, visible: true, branches: ['مرکزی', 'شمال', 'جنوب'] },
  ...
  { id: 's6',  name: 'Pasta Carbonara',     categoryId: 'cat-1', subCategory: '', subSubCategory: '', price: 14.0, description: "Spaghetti à la crème, lardons, parmesan et jaune d'œuf.",               photo: '', tags: ['Populaire'],              recipe: [{ stockId: '6', quantity: 2 }, { stockId: '10', quantity: 0.06 }], available: true, prepTime: 18, visible: true, branches: ['جنوب', 'غرب'] },
  { id: 's7',  name: 'Risotto champignons', categoryId: 'cat-1', subCategory: '', subSubCategory: '', price: 13.5, description: 'Risotto crémeux aux champignons des bois, parmesan et herbes fraîches.', photo: '', tags: ['Végétarien'],             recipe: [{ stockId: '5', quantity: 0.04 }, { stockId: '10', quantity: 0.05 }], available: true, prepTime: 25, visible: true, branches: ['مرکزی'] },
  { id: 's8',  name: 'Crème brûlée',        categoryId: 'cat-2', subCategory: '', subSubCategory: '', price: 7.0,  description: 'Crème vanille avec sa croûte de sucre caramélisée à la flamme.',       photo: '', tags: ['Végétarien', 'Populaire'], recipe: [{ stockId: '6', quantity: 3 }, { stockId: '7', quantity: 0.2 }], available: true, prepTime: 15, visible: true, branches: ['مرکزی', 'شمال', 'جنوب', 'غرب'] },
  { id: 's9',  name: 'Mousse au chocolat',  categoryId: 'cat-2', subCategory: '', subSubCategory: '', price: 6.5,  description: 'Mousse au chocolat noir maison, légère et onctueuse.',                  photo: '', tags: ['Végétarien'],             recipe: [{ stockId: '6', quantity: 4 }, { stockId: '5', quantity: 0.02 }], available: true, prepTime: 10, visible: true, branches: ['شمال'] },
...
export function MenuProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <MenuContext.Provider value={{
      data, allTags, stockItems: MENU_STOCK_REFS, branches: MENU_BRANCHES,
